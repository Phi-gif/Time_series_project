...
\caption{Comparaison de la série initiale et de la série après transformation logarithmique}
\label{fig:1}
\end{figure}
...
\begin{table}[h!]
  \begin{center}
    ...
    \begin{tabular}{l|c}
      ...
      ModL2& SARIMAX $(4,0,4)(0,1,1)_{12}$ (sur les résidus)\\
...
\begin{table}[h!]
  \begin{center}
    ...
    \begin{tabular}{l|c|r} 
      ...
      \rowcolor{LightCyan}
      2 & SARIMAX $(4,0,4)(0,1,1)_{12}$& \textbf{66.83503}\\
...
\noindent
Les graphiques ci-dessous montrent les prédictions des deux modèles retenus, sur 3 ans. À droite, la prédiction du modèle L3, à gauche celle du modèle 2.
